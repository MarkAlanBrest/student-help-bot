...
export default function Home() {
  ...
  return (
    ...
    // ⭐ BACKDROP (makes page look like popup)
    <div className="min-h-screen bg-slate-200 flex items-center justify-center p-4">

      {/* ⭐ POPUP WINDOW */}
      <div className="w-full max-w-md h-[85vh] flex flex-col bg-white border border-slate-300 rounded-2xl shadow-2xl overflow-hidden">

        {/* POPUP HEADER */}
        <div className="px-4 py-3 bg-slate-800 text-white flex items-center justify-between">
          <div className="font-semibold">NCST Canvas Help Assistant</div>

          <button
            onClick={() => window.close()}
            className="text-slate-300 hover:text-red-400 text-sm font-medium"
          >
            Close
          </button>
        </div>
